(function () {
    ...
    $("#api_selector")[0].childNodes[3].remove(); //Remove Api_key textbox
    $("#api_selector")[0].childNodes[4].remove(); //Remove Explorer button
    ...
    $(function () {
        (function () {
            ...
            $('<div id="sa-btn-setting" class="sa-btn">Log in</div>')
                .click(function () {
